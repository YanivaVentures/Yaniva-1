        ...
        <div id="services" className="bg-gray-100 py-12">
            <section data-aos="zoom-in-down">
                <div className="my-4 py-4">
                    <h2 className="my-2 text-center text-3xl uppercase font-bold"style={{ color: 'rgb(0, 153, 153)' }}>services</h2>
                    <div className='flex justify-center'>
                        <div className='w-24 border-b-4'
  style={{ borderBottomColor: 'rgb(0, 153, 153)' }}></div>
                    </div>
                    <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-gray-500">We are deeply committed to the growth and success of our clients.</h2>
                </div>
