...
import heroImg from '../images/main.svg';
            ...
            <div className="hero" id='hero'>
                ...
                <div className="m-auto overflow-hidden mx-4 mt-8 lg:mt-4 p-2 md:p-12 h-5/6" data-aos="zoom-in">
                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        ...
                        <h1 className="mb-5 md:text-5xl text-3xl font-extrabold" style={{ color: 'rgb(0, 153, 153)' }}>
                            {/* We build digital solutions to help businesses scale */}
                                YANIVA
                            </h1>
                            <h2 className="mb-5 md:text-5xl text-3xl font-bold"style={{ color: 'rgb(0, 153, 153)' }}>
                            {/* We build digital solutions to help businesses scale */}
                                "Prosper Together" 
                            </h2>
                            <div className="text-2xl font-semibold tracking-tight mb-5 text-gray-500">Explore the exclusive marketplace for forecoming IPOs, aspiring to transform our world.</div>
